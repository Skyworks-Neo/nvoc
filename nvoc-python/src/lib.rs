...
use nvoc_core::{
    ...
    SetNvapiTargetTemp, SetNvapiTgpWatt, SetNvapiVoltRailOffset, SetNvmlPstateLock, SetPowerLimit,
    ...
    discover_targets, nvml_pstate_to_str, parse_nvml_fan_control_policy, run,
