...
> **Snapshot:** This inventory reflects the `nvapi-rs` tree and driver evidence
> available on 2026-08-25. Wrapper status and candidate priority can become
> stale; compare against current code before acting on any row.
