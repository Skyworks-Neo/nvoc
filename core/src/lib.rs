...
pub use operation::{
    ...
    QueryNvapiPmgrVoltageArbiter, QueryNvapiPstates20Private, QueryNvapiRatedTdp,
    ...
    QueryVbiosStatusString, QueryVbiosVersion, QueryVfpPointVoltage, QueryViolationStatus,
