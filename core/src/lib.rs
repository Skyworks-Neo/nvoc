...
pub use operation::{
    ...
    SetCoolerLevels, SetDomainVfpDeltas, SetEdid, SetFanCurve, SetFanRpm, SetFanSpeed, SetFanStop,
    SetForcePstate, SetLegacyClocks, SetLockedClocks, SetNvapiBackgroundOcScanner,
    ...
    SetNvapiPmgrVoltageArbiter, SetNvapiPowerLimits, SetNvapiPstateLock, SetNvapiSensorLimits,
    ...
    SetNvapiVoltRailTarget, SetNvmlAcousticTemp, SetNvmlPstateLock, SetPowerLimit, SetPowerMode,
    SetPstateBaseVoltage, SetPstateClockOffset, SetTemperatureLimit, SetVfpFrequencyLock,
    SetVfpPointDelta, SetVfpRangeDelta, SetVfpVoltageLock, SetVoltageBoost, SetWm2Active,
    SetWm2Mode, TgpWattRangeInfo, detect_gpu_type, fetch_gpu_type, find_matching_vfp_point,
