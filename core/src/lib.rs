...
pub use operation::{
    ...
    QueryLegacyCoreOvervoltRanges, QueryLegacyP0CoreMaxVoltageDelta, QueryNvapiTargetTempPolicies,
    ...
    SetVfpRangeDelta, SetVfpVoltageLock, SetVoltageBoost, TgpWattRangeInfo, detect_gpu_type,
    fetch_gpu_type, find_matching_vfp_point, legacy_core_overvolt_ranges,
