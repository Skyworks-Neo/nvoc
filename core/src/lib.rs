...
pub use operation::{
    ...
    nvml_pstate_to_str, parse_nvapi_locked_voltage_target, parse_nvml_fan_control_policy, OemOcScanner, OemOcScannerAction, SetForcePstate, RestartDisplayDriver,
