...
pub use operation::{
    ...
    QueryVbiosVersion, QueryVfpPointVoltage,
    ...
    SetNvapiPStateNative, SetNvapiOverclockedPstates, SetNvapiPstates20PrivateDelta,
    SetNvapiPerfFreqCap, SetNvapiPerfLevelLock, SetNvapiPmgrVoltageArbiter,
