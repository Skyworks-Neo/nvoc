...
pub use operation::{
    ...
    QueryLegacyCoreOvervoltRanges, QueryLegacyP0CoreMaxVoltageDelta, QueryNvapiTgpWattRange,
    ...
    SetLegacyClocks, SetLockedClocks, SetNvapiDynamicBoost, SetNvapiPowerLimits,
    SetNvapiPstateLock, SetNvapiSensorLimits, SetNvapiTgpWatt, SetNvmlPstateLock, SetPowerLimit,
    SetPstateBaseVoltage, SetPstateClockOffset, SetTemperatureLimit, SetVfpFrequencyLock,
    SetVfpPointDelta, SetVfpRangeDelta, SetVfpVoltageLock, SetVoltageBoost, TgpWattRangeInfo,
