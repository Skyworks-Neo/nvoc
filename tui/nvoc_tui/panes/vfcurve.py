            ...
            with Grid(id="vfcurve-controls-main"):
                with Vertical(classes="column"):
                    ...
                    with Vertical(classes="subpane") as vfp_subpane:
                        ...
                        with Grid(id="vf-import-export-actions"):
                            ...
                            yield Button(
                                mnemonic_text("E", "xport VFP"), id="vf-export", compact=True
                            )
                            yield Button(
                                mnemonic_text("I", "mport VFP"), id="vf-import", compact=True
                            )
                ...
                with Vertical(classes="column"):
                    ...
                    with Vertical(classes="subpane") as freq_adj_subpane:
                        freq_adj_subpane.border_title = "Core Frequency Adjustments (Alt-U)"
                    ...
                    with Vertical(classes="subpane") as mem_adj_subpane:
                        mem_adj_subpane.border_title = "Memory Frequency Adjustments (Alt-M)"
