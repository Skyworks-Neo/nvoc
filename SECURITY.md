...
Please report security-sensitive issues privately via GitHub's private vulnerability reporting: open [Security → Advisories → Report a vulnerability](https://github.com/Skyworks-Neo/nvoc/security/advisories/new). Do not open a public issue before the maintainers have triaged the report. Include:
...
请通过 GitHub 私密漏洞报告渠道提交安全问题：[Security → Advisories → Report a vulnerability](https://github.com/Skyworks-Neo/nvoc/security/advisories/new)。在维护者完成分诊之前，请勿公开提交 issue。请包含：
