...
> **Driver-specific evidence:** Handler addresses, accepted versions, and
> layouts below apply to the analyzed R610.74 binary. Re-derive them before use
> with another driver build; private setters are not approved by this document.
