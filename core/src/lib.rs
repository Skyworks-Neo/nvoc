...
pub use operation::{
    ...
    QueryLegacyCoreOvervoltRanges, QueryLegacyP0CoreMaxVoltageDelta, QueryNvapiThermalSettings,
    ...
    SetLockedClocks, SetNvapiPowerLimits, SetNvapiPstateLock, SetNvapiSensorLimits,
    SetNvmlAcousticTemp, SetNvmlPstateLock, SetPowerLimit, SetPstateBaseVoltage,
