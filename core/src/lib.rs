...
pub use operation::{
    ...
    ResetPstateGlobalFreqOffset, ResetPublicVftableOffset, ResetVfpFrequencyLock, ResetPublicVftableGpcLock,
    RestartDisplayDriver, SetAutoboostSupport, SetApplicationsClocks, SetAutoboostStatus,
    ResetAutoboostStatus, SetBb2Active, SetClockOffset, SetCoolerLevels, SetDomainVfpDeltas,
    ...
    SetPublicVftableRangeOffset, SetGpcVoltLock, SetVoltageBoost, SetWm2Active, SetWm2Mode,
